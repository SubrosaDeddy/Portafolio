...
public:
	TerrenoRR(int ancho, int alto, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext)
	{
		...
		//CargaParametros(L"Sand/Sand_004_COLOR.png", L"dunesHeightmap.jpg", 100.0f);
		//CargaParametros(L"Sand/Sand_004_COLOR.png", L"dunesHeightmap2.jpg", 100.0f);
		CargaParametros(L"Sand/Sand_004_COLOR.png", L"Assets/Granite/Granite_002_COLOR_COLOR.jpg", L"dunesHeightmap2V3.jpg", 100.0f);
	}
	...
	bool CargaParametros(WCHAR* diffuseTex, WCHAR*shadowTex, WCHAR* heightTex, float tile)
	{
		HRESULT d3dResult;
		...
		//d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice, L"Sand/Sand_004_COLOR.png", 0, 0, &colorMap2, 0 );
		d3dResult = D3DX11CreateShaderResourceViewFromFile( d3dDevice, shadowTex, 0, 0, &colorMap2, 0 );
		...
		//de difusa
		d3dResult = d3dDevice->CreateBuffer(&constDesc, 0, &diffBuf);
	...
	void Draw(D3DXMATRIX vista, D3DXMATRIX proyeccion, D3DXVECTOR3 posCam, D3DXVECTOR3 lightDir, D3DXVECTOR3 ambientColor, D3DXVECTOR3 diffuseColor, float FAA, float FAD)
	{
		...
		d3dContext->UpdateSubresource(diffBuf, 0, 0, &diffuse, 0, 0);
		...
		d3dContext->VSSetConstantBuffers(4, 1, &ambientBuf);
		d3dContext->VSSetConstantBuffers(5, 1, &diffBuf);
